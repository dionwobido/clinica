...
class EspecialidadesList extends TPage
{
    protected $form;
    protected $datagrid;
    ...
    public function __construct()
    {
        ...
        $this->addFilterField('titulo', 'like','titulo');
        
        $this->form = new BootstrapFormBuilder('form_search_Especialidades');
        ...
        $this->form->addActionLink(_t('New'), new TAction(['EspecialidadesForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['EspecialidadesForm', 'onEdit'], ['id' =>'{id}', 'register_start' =>'false']);
